...
# Name:    MelissaGeoCoderObjectLinuxJava
# Purpose: Use the Melissa Updater to make the MelissaGeoCoderObjectLinuxJava code usable
...
Wrapper_FileName="libmdGeoJavaWrapper.so"
...
cd $ProjectPath
printf "\n=========================== BUILD PROJECT ==========================\n"
javac -cp .:com/melissadata/*.java MelissaGeoCoderObjectLinuxJava.java
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/.
jar cvfm MelissaGeoCoderObjectLinuxJava.jar manifest.txt com/melissadata/*.class *.class *.so

# Run project
if [ -z "$zip" ];
then
    java -jar MelissaGeoCoderObjectLinuxJava.jar --license $license --dataPath $DataPath
else
    java -jar MelissaGeoCoderObjectLinuxJava.jar --license $license --dataPath $DataPath --zip $zip
fi
